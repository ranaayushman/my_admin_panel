              ...
              {currentEvent.eventBanner?.url && (
                <div>
                  ...
                  <div className="relative h-48 w-full overflow-hidden rounded-lg border border-gray-200">
                    <Image
                      src={currentEvent.eventBanner.url}
